...
RUN pip install cython numpy coveralls wget nibabel dipy networkx awscli boto3 plotly==1.12.9 python-dateutil==2.5 requests==2.5.3 pyvtk matplotlib==1.5.1 scikit-learn scikit-image nilearn
RUN pip install ndmg==0.0.50
